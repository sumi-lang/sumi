...
/// What may reach a function's parameters, the hull of its live call
/// sites' arguments, and what its result may be. Empty parameters mean no
/// live call site: the function is dead, and nothing in it is checked.
#[derive(Debug)]
pub struct Ranges {
    pub params: Box<[May]>,
    pub result: May,
