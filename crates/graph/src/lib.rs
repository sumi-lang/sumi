...
//! types, the mathematical integer, and the graph of every definition a
//! file's bodies make. The checker above builds the graph and decides
//! what is wrong with it; nothing here depends on the checker.
