...
fn holes_split_a_string_into_parts() {
    ...
    check(
        ...
        &[
            r#"String 0..1 "\"""#,
            r#"Punct 1..2 "{" TokenFlags(HOLE_AFTER)"#,
            r#"Ident 2..3 "a" TokenFlags(HOLE_AFTER)"#,
            r#"Punct 3..4 "}""#,
            r#"Punct 4..5 "{" TokenFlags(HOLE_AFTER)"#,
    ...
    check(
        ...
        &[
            ...
            r#"Punct 1..2 "{" TokenFlags(HOLE_AFTER)"#,
            r#"Ident 2..3 "a" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 3..4 " " TokenFlags(HOLE_AFTER)"#,
            r#"Punct 4..5 "{" TokenFlags(HOLE_AFTER)"#,
            r#"Ident 5..6 "b" TokenFlags(HOLE_AFTER)"#,
            r#"Punct 6..7 "}" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 7..8 " " TokenFlags(HOLE_AFTER)"#,
            r#"Ident 8..9 "c" TokenFlags(HOLE_AFTER)"#,
            r#"Punct 9..10 "}""#,
            r#"String 10..11 "\"""#,
        ],
    );
    check(
        ...
        &[
            r#"String 0..1 "\"""#,
            r#"Punct 1..2 "{" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 2..3 " " TokenFlags(HOLE_AFTER)"#,
            r#"String 3..6 "\"x\"" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 6..7 " " TokenFlags(HOLE_AFTER)"#,
            r#"Punct 7..8 "}""#,
            r#"String 8..9 "\"""#,
        ],
    );
...
fn a_hole_ends_with_its_line() {
    ...
    check(
        ...
        &[
            ...
            r#"Ident 2..3 "a" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 3..4 " " TokenFlags(HOLE_AFTER)"#,
            r#"LineComment 4..10 "// c}\"" TokenFlags(HOLE_AFTER)"#,
            r#"Newline 10..11 "\n""#,
            r#"Ident 11..12 "b""#,
        ],
    );
...
fn a_string_in_a_hole_may_have_holes() {
    ...
    check(
        ...
        &[
            ...
            r#"Punct 1..2 "{" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 2..3 " " TokenFlags(HOLE_AFTER)"#,
            r#"String 3..4 "\"" TokenFlags(HOLE_AFTER)"#,
            r#"Punct 4..5 "{" TokenFlags(HOLE_AFTER)"#,
            r#"Ident 5..6 "a" TokenFlags(HOLE_AFTER)"#,
            r#"String 6..7 "\"" TokenFlags(HOLE_AFTER)"#,
            r#"HorizontalSpace 7..8 " " TokenFlags(HOLE_AFTER)"#,
            r#"Punct 8..9 "}""#,
            r#"Newline 9..10 "\n""#,
        ],
